{{ config(materialized='view', schema='arab_acmg_harmonized', tags=['t002', 'phase3', 'gnomad', 'exomes']) }}
...
with raw_union as (
    select
        ...
        'exomes' as cohort,
        'gnomad_v4_1_exomes_chr13_raw' as source_table,
        chrom as chrom_raw,
        pos,
        ref,
        alt,
        ...
        filter,
        info
    from {{ source('gnomad_raw', 'gnomad_v4_1_exomes_chr13_raw') }}
    ...
    select
        ...
        date '2026-03-03' as snapshot_date,
        'exomes' as cohort,
        'gnomad_v4_1_exomes_chr17_raw' as source_table,
        chrom as chrom_raw,
        pos,
        ref,
        alt,
        ...
        filter,
        info
    from {{ source('gnomad_raw', 'gnomad_v4_1_exomes_chr17_raw') }}
),
expanded as (
    select
        source_name,
