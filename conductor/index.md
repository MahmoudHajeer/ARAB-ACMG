# Conductor Index: ARAB-ACMG Research

This index serves as the entry point to all project documentation and tracking.
...
- **Current Setup State**: [conductor/setup_state.json](./setup_state.json)
